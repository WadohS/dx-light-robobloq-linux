...
printf 'DX-Light installed. Reconnect to GNOME before opening the panel extension.\n'
printf 'Optional wallpaper sync: systemctl --user enable --now robobloq-wallpaper-sync.service\n'
